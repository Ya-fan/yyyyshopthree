    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-2 text-center">
                <img class="img-circle" src="/web/uploads/avatar/20170313/159419a875565b1afddd541fa34c9e65.jpg"
                     width="100px" height="100px"/>
            </div>
            <div class="col-lg-9">
                <dl class="dl-horizontal">
                    <dt>姓名：</dt>
                    <dd><?= $member_info['nickname'] ?></dd>
                    <dt>手机：</dt>
                    <dd><?= $member_info['mobile'] ?></dd>
                    <dt>性别：</dt>
                    <dd><?php if( $member_info['sex'] == 0 ){echo '未填写';}else if( $member_info['sex'] == 1 ){echo '男';}else{echo '女';} ?></dd>
                </dl>
            </div>
        </div>
        <div class="row m-t">
