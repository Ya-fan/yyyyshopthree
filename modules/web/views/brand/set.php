...
?>
<?=  \Yii::$app->view->renderFile('@app/modules/web/views/common/tab_brand.php',['current'=>'set']);?>
    ...
    <div class="col-lg-12">
        ...
        <div class="form-horizontal m-t m-b">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="name" class="form-control" placeholder="请输入品牌名称~~" value="<?= $info['name'] ? $info['name']:'' ; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form class="upload_pic_wrap" target="upload_file" enctype="multipart/form-data" method="POST"
                        ...
                        <span class="pic-each">
							<img src="<?= UrlService::buildImgUrl('brand',$info['logo']) ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="mobile" class="form-control" placeholder="请输入联系电话~~" value="<?= $info['mobile'] ? $info['mobile']:'' ; ?>">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <textarea name="description" class="form-control" rows="4"><?= $info['description'] ? $info['description']:'' ; ?></textarea>
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
