...
?>
<?=  \Yii::$app->view->renderFile('@app/modules/web/views/common/tab_book.php', ['current'=>'info']);?>
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>库存总量：5</p>
                <p>图书标签：浪潮,吴军</p>
                <p>封面图：<img src="/uploads/book/20170301/7a976289c2c1f551a4f21232575ba255.jpg"
                            style="width: 50px;height: 50px;"/></p>
                <p>图书描述：
                <p>
                    <span style="color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);">《</span><span
                            style="color: rgb(204, 0, 0); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);">浪潮之巅</span><span
                            style="color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);">》是吴军所著图书，现已更新至第三版，由人民邮电出版社出版，主要讲述了IT产业发展的历史脉络和美国硅谷明星公司的兴衰沉浮。内容简介近一百多年来，总有一些公司很幸运地、有意识或者无意识地站在技术革命的浪尖之上。一旦处在了那个位置，即使不做任何事，也可以随着波浪顺顺当当地</span>
                </p>
                <p>
                    <span style="color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);"><br/></span>
                </p>
                <p>
                    <span style="color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);"><img
                                src="/uploads/book/20170301/9ff354fe52dc26f672d7f94a58f6a2f4.jpg"/></span></p>
                <p>
                    <span style="color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);"><img
                                src="/uploads/book/20170301/e9a3909b1c2db975d1b3c21c249c684e.jpg"/></span></p></p>
            </div>
        </div>
        <div class="row m-t">
            <div class="col-lg-12">
